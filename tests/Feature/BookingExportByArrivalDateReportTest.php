...
use App\Exports\BookingExportByArrivalDateExcel;
...
class BookingExportByArrivalDateReportTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_a_new_instance_of_booking_export_report_can_be_created_and_a_generated_report_model_is_returned()
    {
        ...
        $report = (new BookingExportAction)->execute(
            new BookingExportByArrivalDateExcel(
                $this->bookings->first()->arrival_date
            )
        );
